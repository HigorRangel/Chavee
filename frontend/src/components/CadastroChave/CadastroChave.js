                                        ...
                                        <Row className="mb-3">
                                            <Col xs={2}>
                                                <Form.Group controlId="formCodigoImovelCad">
                                                    ...
                                                    <Form.Control required type="text" placeholder="Ex: V1234" maxLength = "10"></Form.Control>
                                                </Form.Group>
                                            </Col>
                                            <Col xs={5}>
                                                <Form.Group controlId="formLogradouroCad">
                                                    <Form.Label>Logradouro</Form.Label>
                                                    <Form.Control required type="text" placeholder="Ex: Rua das Maravilhas" maxLength = "100"></Form.Control>
                                                </Form.Group>
                                            </Col>
                                            <Col xs={2}>

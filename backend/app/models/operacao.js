...
module.exports = {
    getOperacoesByImobiliariaId:function (id_imobiliaria,connection,callback){
        sql =`select o.id,COALESCE(ch.cod_imovel, "n/D") as imovel,ch.id as id_chave,CONCAT (ch.rua,' ',ch.numero,', ',ch.bairro,' ',ch.cidade) as endereco,o.descricao_retirada,o.nome_cliente,o.entrega_prevista,o.data_retirada from operacao o 
